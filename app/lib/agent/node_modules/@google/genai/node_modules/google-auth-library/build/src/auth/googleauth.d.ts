...
import { CredentialBody, ImpersonatedJWTInput, JWTInput } from '@google/genai/node_modules/google-auth-library/build/src/auth/credentials';
import { IdTokenClient } from '@google/genai/node_modules/google-auth-library/build/src/auth/idtokenclient';
import { GCPEnv } from '@google/genai/node_modules/google-auth-library/build/src/auth/envDetect';
import { JWT } from '@google/genai/node_modules/google-auth-library/build/src/auth/jwtclient';
import { UserRefreshClient } from '@google/genai/node_modules/google-auth-library/build/src/auth/refreshclient';
import { Impersonated } from '@google/genai/node_modules/google-auth-library/build/src/auth/impersonated';
import { ExternalAccountClientOptions } from '@google/genai/node_modules/google-auth-library/build/src/auth/externalclient';
import { BaseExternalAccountClient } from '@google/genai/node_modules/google-auth-library/build/src/auth/baseexternalclient';
import { AuthClient, AuthClientOptions } from '@google/genai/node_modules/google-auth-library/build/src/auth/authclient';
import { ExternalAccountAuthorizedUserClient } from '@google/genai/node_modules/google-auth-library/build/src/auth/externalAccountAuthorizedUserClient';
import { AnyAuthClient, AnyAuthClientConstructor } from '@google/genai/node_modules/google-auth-library';
/**
